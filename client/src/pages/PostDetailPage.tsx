...
export default function PostDetailPage() {
  ...
  const imageItems = post.mediaItems?.filter((m) => m.resourceType === 'image') ?? [];
    ...
    <article className={styles.article}>
      {post.coverImageUrl && (
        <div className={styles.hero}>
          <img src={post.coverImageUrl} alt={post.title} className={styles.heroImage} />
      ...
      <div className={styles.content}>
        <header className={styles.header}>
          <Link to={`/countries/${post.country.slug}`} className={styles.countryLink}>
